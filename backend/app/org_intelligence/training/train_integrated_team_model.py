...
def train_integrated_team_model(train_start: int = 2014, train_end: int = 2020) -> str:
    version = "team-integrated-v1"
    artifact_path = ARTIFACT_DIR / f"integrated_team_{version}.json"
    ...
    with SessionLocal() as db:
        db.add(
            MlModelRun(
                model_family="integrated_team_model",
                ...
                test_year_end=None,
                metrics_json=json.dumps({"status": "org adjusted"}),
